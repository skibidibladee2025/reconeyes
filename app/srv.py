...
from controllers import scrape, scrape_hacked_camera, markers_list
...
def scrape_all_cams():
    try:
        os.remove('markers_loading.json')
    except FileNotFoundError:
        pass

    with open('markers_loading.json', 'w') as f:
    ...
    try:
        ...
        pass
    os.rename('markers_loading.json', 'markers.json')
