...
function refreshCameras() {
    ...
    fetch('/.netlify/functions/scrape')
        ...
        .catch(error => {
            ...
            $("#loader").hide();
            $("#map").show();
            alert('Failed to refresh cameras. Please try again.');
        });
}
...
function initMap() {
    ...
    $.getJSON("/markers.json", function (locations) {
                ...
                <table>
                    <tr>
                        <a target="_blank" href="${stream}">
                            <iframe src="${stream}" width="200" height="150"></iframe>
                        </a>
                    </tr>
                    <tr>
